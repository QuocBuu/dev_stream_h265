...
using namespace rtc; // clean prefix "rtc::"
using namespace std; // clean prefix "std::"
using namespace std::chrono_literals; // clean prefix "std::chrono_literals::"

using json = nlohmann::json; // replace name
...
/// Main dispatch queue
DispatchQueue MainThread("Main"); // Note
